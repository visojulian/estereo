          ...
          <Container>
            <Box sx={{ pt: '8em' }}>
              ...
              <table sx={{ ...styles.table, ...styles.viernes }}>
                <thead>
                  <tr>
                    <th colSpan={2}>Biblioteca Argentina<br />
                      <Link
                        path={'https://maps.app.goo.gl/R3U7yXbGEeqmufX76'}
                        target='_blank'
                        sx={{ color: 'third' }}
                      >
                        Cómo llegar
                ...
                <tbody>
                  <tr>
                    <td>10:00 hs <br /> Presentación del Circuito Iberoamericano de Festivales de Podcast.</td>
                  ...
                  <tr>
                    <td>14:00 hs <br /> Periodismo especializado en Podcast</td>
                  ...
                  <tr>
                    <td>14:45 hs <br /> Lo que hacemos en las sombras (el rol de la producción)</td>
                  ...
                  <tr>
                    <td>15:15 hs <br /> El futuro del podcast de ficción en Latinoamérica</td>
                  ...
                  <tr>
                    <td>15:45 hs <br /> ¿Cómo financiar un podcast?</td>
                  ...
                  <tr>
                    <td>16:15 hs <br /> El podcast en los medios</td>
                  ...
                  <tr>
                    <td>17:45 hs <br /> Distribución y comercialización: lo menos sexy del podcast</td>
              ...
              <table sx={{ ...styles.table, ...styles.viernes }}>
                <thead>
                  <tr>
                    <th colSpan={2}>Galpón 11<br />
                      <Link
                        path={'https://maps.app.goo.gl/LxZvPb4JQppgwHVq5'}
                        target='_blank'
                        sx={{ color: 'third' }}
                      >
                        Cómo llegar
              ...
              <table sx={{ ...styles.table, ...styles.sabado }}>
                <thead>
                  <tr>
                    <th colSpan="2">Sede Gobierno UNR - Salón de los Espejos<br />
                      <Link
                        path={'https://maps.app.goo.gl/ZcwF5cwk2htzcJS68'}
                        target='_blank'
                        sx={{ color: 'third' }}
                      >
                        Cómo llegar
              ...
              <table sx={{ ...styles.table, ...styles.sabado }}>
                <thead>
                  <tr>
                    <th colSpan="2">
                      Sede UNR - Primer Piso Aula 1 <br />
                      <Link
                        path={'https://maps.app.goo.gl/iGwRjPosF114PdAi8'}
                        target='_blank'
                        sx={{ color: 'third' }}
                      >
                        Cómo llegar
                ...
                <tbody>
                  <tr>
                    <td>10:00 a 11:30 hs </td>
                    <td> Taller: Escribe por los Derechos es una campaña global que Amnistía Internacional realiza todos los años durante el segundo semestre. En ella se invita a enviar cartas de apoyo a personas cuyos derechos humanos están siendo vulnerados en distintas partes del mundo y cartas para exigirles a las autoridades responsables de velar por esos derechos que actúen de manera acorde.
                      Es una excelente propuesta para propiciar debates sobre derechos humanos teniendo en cuenta la situación a nivel global, a partir de casos de actualidad.</td>
                  </tr>
                </tbody>
              </table>
              <table sx={{ ...styles.table, ...styles.sabado }}>
              ...
              <table sx={{ ...styles.table, ...styles.domingo }}>
                <thead>
                  <tr>
                    <th colSpan={2}>Cine El Cairo<br />
                      <Link
                        path={'https://maps.app.goo.gl/CxTNLzsM4uMz16WZ9'}
                        target='_blank'
                        sx={{ color: 'third' }}
                      >
                        Cómo llegar
