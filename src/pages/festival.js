          ...
          <Container sx={{ maxWidth: ['100%', '100%', '100%', '100%', '100%', '70%'] }}>
            ...
            <Box>
              <Text as="p" variant="heroSecondary" sx={styles.text2}>
                ...
                calendario. Recordá que todo es gratuito. <b><Link path={'#'} sx={{ color: 'gray' }}>Ver grilla (próximamente)</Link></b>.
              </Text>
            </Box>
          </Container>
          <Container sx={{ maxWidth: ['100%', '100%', '100%', '100%', '100%', '70%'] }}>
            ...
            <Box>
              ...
              <Text as="p" variant="heroSecondary" sx={styles.text2}>
                ...
                Si te interesa acceder a cualquiera de estas actividades, lo podés hacer <b><Link path={'/convocatorias'}>desde acá</Link></b>.
              </Text>
            </Box>
          </Container>
          <Container sx={{ maxWidth: ['100%', '100%', '100%', '100%', '100%', '70%'] }}>
            ...
            <Box>
              <Text as="p" variant="heroSecondary" sx={styles.text2}>
                ...
                Si te interesa todo este mundo de conectividad y desarrollo, <b><Link path={'/convocatorias'}>acá te dejamos más info</Link></b>.
              </Text>
            </Box>
            <hr />
          </Container>
